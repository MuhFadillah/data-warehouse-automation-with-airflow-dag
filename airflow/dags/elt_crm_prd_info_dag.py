...
with DAG(
    ...
    run_elt_job = BashOperator(
        ...
        bash_command='spark-submit --packages org.apache.hadoop:hadoop-aws:3.3.2,com.amazonaws:aws-java-sdk-bundle:1.11.1026 /mnt/d/data_engineering/spark/scripts/elt_crm_prd_info.py'
    )
